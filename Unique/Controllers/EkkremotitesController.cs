...
{
    [Authorize]
    public class EkkremotitesController : Controller
    {
        private readonly MvcProductsContext _context;

        public EkkremotitesController(MvcProductsContext context)
        {
            _context = context;
        }
